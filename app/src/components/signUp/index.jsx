...
export default function SignUp() {
    ...
    return (
        <div className='flex flex-row-reverse bg-auto' style={{
            backgroundImage: `url(${SignUpBackground})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', width: '100vw',
            height: '100vh'
        }} >
            <div className='basis-full lg:basis-5/12 p-4 bg-white bg-opacity-50 sm:p-6 md:p-8 dark:bg-gray-200 dark:border-gray-700'>
                ...
                <h1 className='font-semibold text-4xl my-5 px-4'>Sign Up</h1>
                <div className="grid grid-cols-1 gap-4">
                    <EmailField placeholderText="Enter your Email Address"/>
