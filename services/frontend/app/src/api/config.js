...
export const NOTIFICATION_COMPLEX_ENDPOINT = `http://${REACT_APP_API_ENDPOINT}:5015`;
export const SHIPMENT_UNLOADING_STATUS_ENDPOINT = `http://${REACT_APP_API_ENDPOINT}:5016`;
export const BL_DOCUMENT_ENDPOINT = `http://${REACT_APP_API_ENDPOINT}:5017/bl_doc`;
