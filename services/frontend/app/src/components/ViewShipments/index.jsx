  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="tab-content border border-black w-3/4 ml-4">
        {activeTab === 'Import' && <div><ViewShipmentComponent title="Incoming Shipments"/></div>}
        {activeTab === 'Export' && <div><ViewShipmentComponent title="Outgoing Shipments"/></div>}
        {activeTab === 'Upcoming' && <div><ViewShipmentComponent title="Upcoming Shipments"/></div>}
      </div>
    </div>
  );
};
