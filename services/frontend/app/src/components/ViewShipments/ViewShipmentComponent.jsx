        ...
        <div className="flex flex-col mt-5">
          ...
          {items.length > 0 && items.map((item, index) => {
            return (
              ...
              <ShipmentCard key={index} item={item} index={index} setLoading={setLoading} title={title} user={user}/>
...
function ShipmentCard({ item, index, setLoading, title, user }) {
      ...
      <Card className={`mb-2 w-full 2xl:w-4/5 ${shipmentStatusColours[status]}`} style={{ borderRadius: "10px" }} key={index}>
        <Card.Body>
          <div className="grid grid-cols-2 text-white p-4">
            ...
            {/* <button onClick={(e) => {e.stopPropagation(); subscribe()}} type="button" className="mt-2 ml-2 mb-2 inline-flex items-center px-5 py-2.5 text-xs  text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> 
              <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
          ...
          Subscribe
            ...
            <br/>
            <button onClick={(e) => {e.stopPropagation(); unsubscribe()}} type="button" className="mt-2 ml-2 mb-2 inline-flex items-center px-5 py-2.5 text-xs  text-center text-white bg-red-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"> 
            <svg className="mr-2" fill="#FFFFFF" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 283.194 283.194" 
            xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"/><g id="SVGRepo_tracerCarrier" 
            strokeLinecap="round" strokeLinejoin="round"/><g id="SVGRepo_iconCarrier"> <g> 
