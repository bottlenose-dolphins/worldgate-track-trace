...
def getImportContainerNum():
    ...
    import_ref_num_response = invokes.invoke_http(IMPORT_URL + "/import/import_ref_n/wguser_id/" + str(wguser_id), method='GET')
    import_ref_num = import_ref_num_response['export_ref_n']

    cont_num_response = invokes.invoke_http(IMPORT_CONT_URL + "/import_cont/cont_num/" + str(import_ref_num), method='GET')
    cont_num = cont_num_response['container_num']
